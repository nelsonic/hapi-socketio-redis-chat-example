...
var _user$project$Main$decodeListOfMessages = _elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string);
var _user$project$Main$parseTimestamp = function (time) {
	return A2(
		_justinmimbs$elm_date_extra$Date_Extra$toFormattedString,
		'd/M/y HH:mm',
		_elm_lang$core$Date$fromTime(time));
};
var _user$project$Main$parseMessage = function (message) {
	var _p0 = message.t;
	switch (_p0) {
		case -1:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('pv3 ph3 animation'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('blue mh1 f6 f5-m f4-l'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(message.m),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				});
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('light-silver f6 f5-m f4-l'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('pv3 ph3 bg-white'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								_user$project$Main$parseTimestamp(message.t)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(message.n),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('mv1 f5 f4-m f3-l'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Main$setName = _elm_lang$core$Native_Platform.outgoingPort(
	'setName',
	function (v) {
		return v;
	});
...
var _user$project$Main$message = _elm_lang$core$Native_Platform.incomingPort('message', _elm_lang$core$Json_Decode$value);
var _user$project$Main$name = _elm_lang$core$Native_Platform.incomingPort('name', _elm_lang$core$Json_Decode$value);
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {name: a, messages: b, messageInput: c, nameInput: d, windowWidth: e};
	});
var _user$project$Main$Message = F3(
	function (a, b, c) {
		return {n: a, t: b, m: c};
	});
var _user$project$Main$decodeMessage = A3(
...
var _user$project$Main$parseMessageListJson = function (json) {
	var decode = _elm_lang$core$Json_Decode$decodeString(_user$project$Main$decodeMessage);
	var $default = A3(_user$project$Main$Message, '', 0, 'problem retrieving message');
	return A2(
		_elm_lang$core$List$map,
		function (message) {
			return A2(
...
var _user$project$Main$parseMessageJson = function (json) {
	return A2(
		_elm_lang$core$Result$withDefault,
		A3(_user$project$Main$Message, '', 0, 'unable to parse message'),
		A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$decodeMessage, json));
};
var _user$project$Main$MessageInput = F2(
	function (a, b) {
		return {input: a, placeholder: b};
	});
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$scrollToBottom = A2(
	_elm_lang$core$Task$attempt,
	_elm_lang$core$Basics$always(_user$project$Main$NoOp),
	_elm_lang$dom$Dom_Scroll$toBottom('container'));
		...
		switch (_p1.ctor) {
			case 'UpdateInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messageInput: A2(_user$project$Main$MessageInput, _p1._0, '')
						}),
			...
			case 'SetName':
				return {
					...
					_1: _user$project$Main$setName(model.nameInput)
				};
			case 'SendMessage':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messageInput: A2(_user$project$Main$MessageInput, '', '')
						}),
					_1: _user$project$Main$sendMessage(model.messageInput.input)
				};
			case 'InvalidMessage':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messageInput: A2(_user$project$Main$MessageInput, '', 'Please enter your message here')
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NewMessageFromPort':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messages: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Main$parseMessageJson(_p1._0),
									_1: {ctor: '[]'}
								})
						}),
					_1: _user$project$Main$scrollToBottom
				};
			case 'NewNameFromPort':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
							...
							messages: A2(
								...
								model.messages,
								{
									...
									_0: A3(
										...
										'',
										-1,
										A2(_elm_lang$core$Basics_ops['++'], _p1._0, ' joined the room')),
									_1: {ctor: '[]'}
								})
						}),
					_1: _user$project$Main$scrollToBottom
				};
			case 'DisplayMessageHistory':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messages: _user$project$Main$parseMessageListJson(_p1._0)
						}),
					_1: _user$project$Main$scrollToBottom
				};
...
var _user$project$Main$ShowErrorMessage = function (a) {
	return {ctor: 'ShowErrorMessage', _0: a};
};
var _user$project$Main$DisplayMessageHistory = function (a) {
	return {ctor: 'DisplayMessageHistory', _0: a};
};
var _user$project$Main$handleFetch = function (result) {
	var _p2 = result;
	if (_p2.ctor === 'Ok') {
		return _user$project$Main$DisplayMessageHistory(_p2._0);
	} else {
		return _user$project$Main$ShowErrorMessage(
			A3(_user$project$Main$Message, '', 0, 'unable to fetch message history'));
	}
};
var _user$project$Main$fetchMessageHistory = A2(
	_elm_lang$core$Task$attempt,
	_user$project$Main$handleFetch,
	_elm_lang$http$Http$toTask(
		A2(_elm_lang$http$Http$get, '/load', _user$project$Main$decodeListOfMessages)));
var _user$project$Main$NewNameFromPort = function (a) {
	return {ctor: 'NewNameFromPort', _0: a};
};
var _user$project$Main$handleName = function (name) {
	var _p3 = A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, name);
	if (_p3.ctor === 'Ok') {
		return _user$project$Main$NewNameFromPort(_p3._0);
	} else {
		return _user$project$Main$ShowErrorMessage(
			A3(_user$project$Main$Message, '', 0, 'an unknown user joined the chat'));
	}
};
var _user$project$Main$NewMessageFromPort = function (a) {
	return {ctor: 'NewMessageFromPort', _0: a};
};
var _user$project$Main$handleMessage = function (message) {
	var _p4 = A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, message);
	if (_p4.ctor === 'Ok') {
		return _user$project$Main$NewMessageFromPort(_p4._0);
	} else {
		return _user$project$Main$ShowErrorMessage(
			A3(_user$project$Main$Message, '', 0, 'unable to parse message'));
	}
};
var _user$project$Main$InvalidMessage = {ctor: 'InvalidMessage'};
var _user$project$Main$SendMessage = {ctor: 'SendMessage'};
var _user$project$Main$validateMessage = function (model) {
	var _p5 = model.messageInput.input;
	if (_p5 === '') {
		return _user$project$Main$InvalidMessage;
	} else {
		return _user$project$Main$SendMessage;
	}
};
var _user$project$Main$SetName = {ctor: 'SetName'};
	...
	if (_p6.ctor === 'Just') {
		return {
			...
			_0: A5(
				...
				_p6._0,
				{ctor: '[]'},
				A2(_user$project$Main$MessageInput, '', ''),
				'',
				0),
			_1: _elm_lang$core$Platform_Cmd$batch(
				{
					ctor: '::',
					_0: A2(_elm_lang$core$Task$perform, _user$project$Main$Resize, _elm_lang$window$Window$width),
					_1: {
						ctor: '::',
						_0: _user$project$Main$fetchMessageHistory,
						_1: {ctor: '[]'}
					}
				})
		};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: _elm_lang$window$Window$resizes(
				function (_p7) {
					var _p8 = _p7;
					return _user$project$Main$Resize(_p8.width);
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Main$message(_user$project$Main$handleMessage),
				_1: {
					ctor: '::',
					_0: _user$project$Main$name(_user$project$Main$handleName),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Main$UpdateNameInput = function (a) {
	return {ctor: 'UpdateNameInput', _0: a};
};
var _user$project$Main$login = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('pa4 black-80'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$SetName),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('measure'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('f6 b db mb2'),
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-describedby', 'name-desc'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('input-reset ba b--black-20 pa2 mb2 db w-100'),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateNameInput),
													_1: {ctor: '[]'}
												}
											}
										}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('f6 black-60 db mb2'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('name-desc'),
										_1: {ctor: '[]'}
									}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Helper text for the form control.'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Main$chat = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('helvetica'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('list w-100 pt0 pl0 pr0 pb5rem ma0'),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$core$List$map, _user$project$Main$parseMessage, model.messages)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$form,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('bg-near-black h3_5 w-100 bw2 fixed bottom-0 pt2'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(
								_user$project$Main$validateMessage(model)),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fixed bottom-1 left-1 ba0 f3 pv2 border-box'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$style(
										{
											...
											_0: {
												...
												_1: A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(model.windowWidth - 148),
													'px')
											},
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.messageInput.input),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder(model.messageInput.placeholder),
											_1: {
												ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fixed bottom-1 right-1 fr ba0 ph1 f3 pv2 white border-box'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$style(
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'width', _1: '103px'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#4DB6AC'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'border-color', _1: '#4DB6AC'},
														_1: {ctor: '[]'}
													}
												}
											}),
...
var _user$project$Main$view = function (model) {
	var _p9 = model.name;
	if (_p9 === '') {
		return _user$project$Main$login(model);
	} else {
		return _user$project$Main$chat(model);
	}
};
